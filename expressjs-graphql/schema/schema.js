    ...
    fields: () => ({
        ...
        users: {
            ...
            async resolve(parentValue, args) {
                ...
                const res = await axios.get(`http://localhost:3000/companies/${company.id}/users`);
                return res.data;
            }
        }
    })
    ...
    fields: () => ({
        ...
        company: {
            ...
            async resolve(parentValue, args) {
                ...
                const res = await axios.get(`http://localhost:3000/companies/${user.companyId}`);
                return res.data;
            }
        }
    })
    ...
    fields: {
        ...
        updateUser: {
            ...
            async resolve(parentValue, {id, firstName, age, companyId}) {
                const res = await axios.patch(`http://localhost:3000/users/${id}`, {firstName, age, companyId});
                return res.data;
            }
        }
    }
